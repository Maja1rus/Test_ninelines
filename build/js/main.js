...
function openMenu() {
  return new Promise(function (resolve) {
    ...
    _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].lockScroll(true, _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$header.find('.header__nav'), 'header');
...
/* harmony import */ var _modules_scrollToTop__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/scrollToTop */ "./src/js/modules/scrollToTop.js");
    ...
    var animOnScroll = function animOnScroll() {
      for (var index = 0; index < animItems.length; index++) {
        ...
        if (scrollY > animItemOffset - animItemPoint && scrollY < animItemOffset + animItemHeight) {
          animItem.classList.add('is-anim-active');
        } else {
          if (!animItem.classList.contains('anim-no-hide')) {
            animItem.classList.remove('is-anim-active');
          }
        }
      }
    };
